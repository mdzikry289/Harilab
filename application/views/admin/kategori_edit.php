...
<head>
    ...
    <title>Harilab - Edit Kategori</title>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header">
                                <a href="<?php echo site_url('admin/category') ?>"><i class="fas fa-arrow-left"></i> Back</a>
                            </div>
                            <div class="card-body">
                                <form action="<?php base_url('admin/category/edit') ?>" method="POST" enctype="multipart/form-data">
