                            ...
                            <div class="card-body">
                                <form action="<?php base_url('admin/client/edit') ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control <?php echo form_error('nama') ? 'is-invalid' : '' ?>" type="text" name="nama" placeholder="" value="<?php echo $client->nama ?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="customFile"><?php echo $client->image ?></label>
