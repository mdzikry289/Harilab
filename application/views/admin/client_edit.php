                            ...
                            <div class="card-body">
                                <form action="<?php base_url('admin/client/edit') ?>" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control <?php echo form_error('nama_client') ? 'is-invalid' : '' ?>" type="text" name="nama_client" placeholder="" value="<?php echo $client->nama_client ?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="customFile"><?php echo $client->image_client ?></label>
                                            <input type="hidden" name="old_image" value="<?php echo $client->image_client ?>" />
                                        </div>
                                        <div class="invalid-feedback">
